...
<!-- testimonial #1 -->
<ContentWidth>
  <ContentBox titleTag="h2" titleText="Why People Love Wireframes" icon="" />
  ...
  {:else}
    ...
    <div
      class="absolute h-10 flex align-middle justify-start xl:left-8 translate-x-[2px] -bottom-16 lg:hidden"
    >
      <div
