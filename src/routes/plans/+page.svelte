  ...
  >
    ...
    >
      ...
      <img
        src={nextArrow}
        alt="next arrow"
        class="w-6 absolute -translate-2 rotate-90 lg:rotate-0 top-[100%] lg:top-[50%] right-[50%] lg:right-0 translate-x-3 plan-arrow"
      />
    </div>
    <div
      class="w-full sm:w-96 lg:w-1/3 flex flex-col justify-center items-center py-5 px-4 mx-auto relative mb-10"
    ...
    >
      ...
      <img
        src={nextArrow}
        alt="next arrow"
        class="w-6 absolute -translate-2 rotate-90 lg:rotate-0 top-[100%] lg:top-[50%] right-[50%] lg:right-0 translate-x-3 plan-arrow hidden"
      />
    </div>
  </div>
...
>
  ...
  <div class="w-11/12 h-24 relative flex flex-row justify-between">
    ...
    >
      <div
        class="w-12 h-12 {step == 1
          ? 'bg-black'
          : 'bg-dark'} hover:bg-black transition-all duration-300 rounded-full text-white flex justify-center items-center mb-5"
      >
        <p class="translate-y-[1px]">1</p>
      </div>
      <h6>Sign Up</h6>
    ...
    <button
      class="flex flex-col justify-center items-center hover:bg-opacity-95"
      onclick={() => setStepWithDelay(2)}
    >
      <div
        class="w-12 h-12 {step == 2
          ? 'bg-black'
          : 'bg-dark'} transition-all duration-300 hover:bg-black rounded-full text-white flex justify-center items-center mb-5"
      >
        <p class="translate-y-[1px]">2</p>
      </div>
      <h6>Set Up</h6>
    ...
    <button
      class="flex flex-col justify-center items-center transition-opacity hover:opacity-95 cursor-pointer"
      onclick={() => setStepWithDelay(3)}
    >
      <div
        class="w-12 h-12 {step == 3
          ? 'bg-black'
          : 'bg-dark'} hover:bg-black transition-all duration-300 rounded-full text-white flex justify-center items-center mb-5"
      >
        <p class="translate-y-[1px]">3</p>
